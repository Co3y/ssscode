...
_data_n3 = pd.read_excel('n3_D.xlsx', header=None)
data_n3 = np.array(_data_n3)

_data_n4 = pd.read_excel('n4_D.xlsx', header=None)
data_n4 = np.array(_data_n4)

_data_n5 = pd.read_excel('n5_D.xlsx', header=None)
...
plt.ylabel('Heterogeneous', fontsize=14)
plt.legend()
plt.show()
